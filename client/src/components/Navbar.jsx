...
const GeneralSettings = () => {
  ...
  return (
      <div>
          {isGeneralOpen && <Settings tab="general" onClose={closeGeneralModal} />}
          <button
...
function SearchInput() {
  return (
    <div id="searchBar" className="flex flex-col justify-center">

      <div className="dark:bg-slate-700 bg-gray-200 rounded-lg overflow-hidden flex">
        <input type="text" className="px-4 py-1 dark:bg-slate-700 bg-gray-200 w-full dark:text-white text-black" placeholder="Search" />
...
function Navbar() {
  ...
  return (location.pathname === "/login" || location.pathname === "/register" ? null :
    <nav className=" h-16 w-full px-5 pb-1 text-gray-500 gap-x-4 flex justify-between">
      <SearchInput />
      <div id="tools" className="flex gap-x-2 md:gap-x-4">
